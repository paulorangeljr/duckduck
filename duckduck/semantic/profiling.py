...
dates — also dates stored as text), a few example values, and — for
categorical columns — every value seen (``values``), which generation
merges into the field's enumerated values.
"""
